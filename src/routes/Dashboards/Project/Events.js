...
const Events = ({ events, onOpen, addProject }) => {
  const classes = useStyles();
  ...
  return (
    <CmtCard>
      <Box display="flex" alignItems="center" flexDirection={{ xs: 'column', sm: 'row' }} className={classes.boxHeader}>
        <CmtCardHeader title="Danh sách dự án" subTitleProps={{ className: classes.subTitleRoot }} />
        <Box style={{ flex: 1 }} />
